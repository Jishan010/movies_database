...
class _$AppDatabase extends AppDatabase {
  ...
  FavMoviesDao? _favMoviesDaoInstance;
  ...
  FavMoviesDao get favMoviesDao {
    return _favMoviesDaoInstance ??= _$FavMoviesDao(database, changeListener);
  }
}
...
class _$FavMoviesDao extends FavMoviesDao {
  ...
  @override
  Future<void> insertFavMovies(FavMovies favMovies) async {
    await _favMoviesInsertionAdapter.insert(
        favMovies, OnConflictStrategy.abort);
  }

  @override
  Future<List<int>> insertAllFavMovies(List<FavMovies> todo) {
    return _favMoviesInsertionAdapter.insertListAndReturnIds(
